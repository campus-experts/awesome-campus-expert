...
- :triangular_flag_on_post: [glfmn/git-workshop](https://codeberg.org/glfmn/git-workshop) - Originally created for HackFSU '17, this workshop hopes to introduce new hackers to the basics of using git.
